...
//Insert Poll
$query = "INSERT INTO `poll` (`poll_title`, `poll_desc`, `created_date`) VALUES ('".$_poll_title."', '".$_poll_desc."', '".$_date_time_stamp."')";
                ...
                foreach ($_condition[$key]["ANSWER"] as $key1 => $value1) {
                    ...
                    if($_question_type[$key]==4){
                        ...
                        if($obj = mysql_fetch_array($result)){
                            ...
                            $query = "INSERT INTO `option_scale` (`choice_id`, `option1`) VALUES ('".$choice_id."', '".$_condition[$key]["OPTION_SCALE"][$key1]."')";
                            $result = mysql_query($query) or die("Error SQL[ ".$query." ] ".mysql_error());
